        ...
        <div className='w-screen bg-black backdrop-blur-xl flex flex-col items-center justify-center p-2 overflow-hidden'>
            <div className='flex-grow min-h-2/3 flex flex-col items-center justify-center heading_line '>
                ...
                <div className='w-1/3 mt-8 text-white text-xl font-semibold flex justify-evenly leading-none'>
                    <button className='px-4 py-3 w-fit bg-gradient-to-r from-[rgb(32,18,223)] to-purple-800 hover:scale-90 hover:cursor-pointer duration-700 rounded-md whitespace-nowrap'>✨ Download</button>
